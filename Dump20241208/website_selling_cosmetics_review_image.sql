...
CREATE TABLE `review_image` (
  `id_review_image` int NOT NULL AUTO_INCREMENT,
  `image` varchar(500) DEFAULT NULL,
  `id_review_user` int NOT NULL,
  PRIMARY KEY (`id_review_image`),
  KEY `FK33ap400tchg4c4at9feimiixq` (`id_review_user`),
  CONSTRAINT `FK33ap400tchg4c4at9feimiixq` FOREIGN KEY (`id_review_user`) REFERENCES `review_user` (`id_review_user`)
