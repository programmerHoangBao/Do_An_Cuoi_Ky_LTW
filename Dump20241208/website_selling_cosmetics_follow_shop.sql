...
--
-- Table structure for table `follow_shop`
--
...
CREATE TABLE `follow_shop` (
  `id_follow_shop` int NOT NULL AUTO_INCREMENT,
  `id_shop` int NOT NULL,
  `id_user` int NOT NULL,
  PRIMARY KEY (`id_follow_shop`),
  KEY `FKc14yp2q0uw7upiyx4j305ndfr` (`id_shop`),
  KEY `FKbqmtahon7rur3ft7kvn6cebrk` (`id_user`),
...
--
-- Dumping data for table `follow_shop`
--
